...
public class LargeHoneycombPillarFeature extends Feature<LargeDripstoneConfiguration> {
    ...
    private static LargePillar makeHoneycomb(BlockPos pRoot, boolean pPointingUp, Random pRandom, int pRadius, FloatProvider pBluntnessBase, FloatProvider pScaleBase) {
